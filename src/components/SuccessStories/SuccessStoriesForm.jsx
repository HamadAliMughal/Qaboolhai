...
const SuccessStoriesForm = () => {
  ...
  return (
    <>
      <Navbar />
      <div>
        <h1 className='ssf-head-text'>Be Inspiration For Others </h1>
        <h6 className='ssf-head-text-t'>Share your success story and tell us how you found your life partner.
          Your full name will not be used on the website</h6>
        <hr />
        <br />
        ...
        <MDBRow>
          ...
          <MDBCol className='col-12 col-lg-4'>
            <MDBValidation className='row g-3' isValidated>
              ...
              <div>
                <MDBFile name='img' value={formValue.img} label='Upload your picture' size='sm' id='formFileSm' onChange={validateImage} required />
              </div>
              <div>
                <MDBTextArea value={formValue.story} name='story' onChange={validateMsg} label='Your Story' id='textAreaExample' rows={5} required />
              </div>
          ...
          <MDBCol className='col-12 col-lg-4'>
            <img className='col-12' src="/img/ssf-img.jpg" alt="" />
          </MDBCol>
